void setup() {
    size(800,600);
    /* @pjs preload="/assets/img/cat.png"; */
...
game.patternFields.push(new patternField(400-133-66, 250, "/assets/img/cat.png", 64, 50));
game.patternFields.push(new patternField(400-66, 250, "/assets/img/cat.png", 80, 62));
game.patternFields.push(new patternField(400+133-66, 250, "/assets/img/cat.png", 100, 80));
