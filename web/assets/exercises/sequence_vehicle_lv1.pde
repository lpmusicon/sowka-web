...
var gamePrototype = function() {
    ...
    this.drawWinState = function() {
        ...
        text("Spróbuj trudniejszego wyzwania", 400, 180);
...
game.patternFields.push(new patternField(400-133, 250, "/assets/img/airplane.png", 100, 68));
game.patternFields.push(new patternField(400, 250, "/assets/img/car.png", 100, 68));
