void setup() {
    size(800,600);
    /* @pjs preload="img/exercises/animals/cat.png"; */
    /* @pjs preload="exercises/reset.png"; */
...
var ResetButtonPrototype = function() {
    ...
    this.width = 40;
    this.height = 40;
    this.img = loadImage("exercises/reset.png");
    this.draw = function() {
...
game.patternFields.push(new patternField(400-133-66, 250, "img/exercises/animals/cat.png", 64, 50));
game.patternFields.push(new patternField(400-66, 250, "img/exercises/animals/cat.png", 80, 62));
game.patternFields.push(new patternField(400+133-66, 250, "img/exercises/animals/cat.png", 100, 80));

PImage tempIMG; tempIMG = loadImage("exercises/reset.png");
void draw() {
    game.draw();
    all = true;
