void setup() {
    size(800,600);
    /* @pjs preload="/assets/img/cow.png"; */
...
game.patternFields.push(new patternField(400-133-66, 250, "/assets/img/cow.png", 64, 50));
game.patternFields.push(new patternField(400-66, 250, "/assets/img/cow.png", 80, 62));
game.patternFields.push(new patternField(400+133-66, 250, "/assets/img/cow.png", 100, 80));
