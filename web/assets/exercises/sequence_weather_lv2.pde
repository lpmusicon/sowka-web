void setup() {
    size(800,600);
    /* @pjs preload="/assets/img/weather/cloud.png"; */
    /* @pjs preload="/assets/img/weather/sun.png"; */
    /* @pjs preload="/assets/img/weather/snowflake.png"; */
...
game.patternFields.push(new patternField(400-200, 250, "/assets/img/weather/cloud.png", 100, 68));
game.patternFields.push(new patternField(400-67, 250, "/assets/img/weather/sun.png", 133, 100));
game.patternFields.push(new patternField(400+66, 250, "/assets/img/weather/snowflake.png", 100, 68));
